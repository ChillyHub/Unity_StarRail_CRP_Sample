...
namespace Unity_StarRail_CRP_Sample.Editor
{
    ...
    class DisplacableRectHandles
    {
        ...
        public Color baseColor
        {
            ...
            set
            {
                m_MonochromeHandleColor = UnityEditor.Rendering.GizmoUtility.GetHandleColor(value);
                m_WireframeColor = UnityEditor.Rendering.GizmoUtility.GetWireframeColor(value);
                m_WireframeColorBehind = UnityEditor.Rendering.GizmoUtility.GetWireframeColorBehindObjects(value);
            }
        }
