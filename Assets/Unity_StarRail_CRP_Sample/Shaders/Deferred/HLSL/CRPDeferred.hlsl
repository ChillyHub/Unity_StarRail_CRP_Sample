#ifndef CRP_DEFERRED_INCLUDED
#define CRP_DEFERRED_INCLUDED
...
Light UnityLightFromPunctualLightDataAndWorldSpacePosition2(PunctualLightData punctualLightData, float3 positionWS, float4 shadowCoord, bool materialFlagReceiveShadowsOff)
{
    Light light;
    ...
    [branch]
    if (materialFlagReceiveShadowsOff)
        light.shadowAttenuation = 1.0;
    else
    {
