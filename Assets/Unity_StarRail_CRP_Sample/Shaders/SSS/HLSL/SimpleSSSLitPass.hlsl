#ifndef CRP_SIMPLE_SSS_LIT_PASS_INCLUDED
#define CRP_SIMPLE_SSS_LIT_PASS_INCLUDED

#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"

#include "../../Deferred/HLSL/CRPGBuffer.hlsl"
#include "../../Shadow/HLSL/CustomShadow.hlsl"
#include "SSSLighting.hlsl"
...
Varyings SimpleSSSLitGBufferPassVertex(Attributes input)
{
...
FragmentOutput SimpleSSSLitGBufferPassFragment(Varyings input, FRONT_FACE_TYPE face : FRONT_FACE_SEMANTIC)
{
    ...
    InitializeSSSLitSurfaceData(input.uv, surfaceData);
    ...
    SSSData sssData;
    sssData.albedo = surfaceData.albedo;
    sssData.thickness = _Metallic;
    sssData.distortion = 0.2;
    sssData.power = 2.0;
    ...
    return SSSBRDFDataToGBuffer(brdfData, sssData, inputData, surfaceData.smoothness, surfaceData.emission + color, 1.0);
}
