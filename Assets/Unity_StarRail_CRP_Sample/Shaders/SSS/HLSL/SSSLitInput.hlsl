#ifndef CRP_SSS_LIT_INPUT_INCLUDED
#define CRP_SSS_LIT_INPUT_INCLUDED
...
TEXTURE2D(_MetalSmoothOcclusion);   SAMPLER(sampler_MetalSmoothOcclusion);
...
inline void InitializeSSSLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    half4 albedoAlpha = SampleAlbedoAlpha(uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
    outSurfaceData.alpha = Alpha(albedoAlpha.a, _BaseColor, _Cutoff);
