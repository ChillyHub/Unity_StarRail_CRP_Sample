Shader "StarRail_CRP/Charater/CharacterWeapon"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "RenderType"="Opaque" "Queue"="Geometry+40" }

        Pass
        {
            Name "Character Weapon GBuffer"
            Tags { "Lightmode"="CharacterGBuffer" "Queue"="Geometry+40" }
            ...
            #pragma fragment CharacterBaseGBufferPassFragment
        ...
        Pass
        {
            Name "Character Weapon GBuffer Outline"
            Tags { "Lightmode"="CharacterOutline" "Queue"="Geometry+40" }
            ...
            #pragma fragment CharacterBaseGBufferOutlinePassFragment
